...
"""
django_app documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'django_app',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/django_app",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'django app having an API to list/filter courses',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'django_app'),
                os.path.join(root_path, 'django_app/migrations')])
