#!/usr/bin/env python
"""
Package metadata for django_app.
"""
import os
import re
import sys
...
def load_requirements(*requirements_paths):
    ...
    # chars allowed in base package name
    re_package_name_base_chars = r"a-zA-Z0-9\-_."
...
VERSION = get_version('django_app', '__init__.py')
...
setup(
    name='django_app',
    version=VERSION,
    description="""django app having an API to list/filter courses""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Open edX Project',
    author_email='oscm@openedx.org',
    url='https://github.com/openedx/django_app',
    packages=find_packages(
        include=['django_app', 'django_app.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "django_app = django_app.apps:DjangoAppConfig",
